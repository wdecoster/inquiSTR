...
p <- arg_parser("Run association testing for STRs with different modes and options, written by Fahri Kucukali. Version 1.0a, October 7, 2022")
...
p <- add_argument(p, "--mode", help="Select a mode name from following: inqH1, inqH2, SUMinqH1H2, MEANinqH1H2", nargs=1)
...
Version = "Run association testing for STRs with different modes and options, written by Fahri Kucukali. Version 1.0a, October 7, 2022"
print(Version)
